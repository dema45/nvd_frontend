...
const View_session = () => {
  ...
  const [itemsPerPage] = useState(5); // You can change this number as needed
  ...
  // Calculate total items whenever sessions change
  useEffect(() => {
  ...
  // Apply sorting whenever sessions change
  useEffect(() => {
  ...
  const handleConfirmDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await axios.delete(`${API_URL}/sessions/${sessionToDelete.id}`);
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">
                    View All Election Session Details
                  </h1>
                </div>
              </div>
            </div>
            ...
            {loading ? (
              <div className="bg-white shadow-xl rounded-2xl p-10">
                <div className="text-center">
                  <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#7083F5] mx-auto"></div>
                          ...
                          >
                            ...
                            <td className="px-4 py-4 whitespace-nowrap text-center">
                              <div className="flex justify-center space-x-3">
                                <Link
                                  to={`/edit_session/${session.session_id}`}
                                ...
                                <button
                                  onClick={() =>
                                    handleDeleteClick(session.session_id, session.session_name)
                                  }
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-md">
            <div className="p-6">
              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    The election session has been deleted successfully.
                  </p>
                </div>
              </div>
            </div>
