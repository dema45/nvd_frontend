...
const PDPPoliticalParty = () => {
  ...
  const candidatesPerPage = 6; // Number of candidates to show per page
    ...
    <div className="bg-white">
      ...
      <section className="py-12 px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">People's Democratic Party</h1>
          <img src={pdp} alt="Party Logo" className="mx-auto h-40 w-auto" />
        </div>

        <div className="bg-white shadow-lg rounded-xl p-8 mb-16 relative">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <img src={cb} alt="Party Leader" className="rounded-lg w-48 h-48 object-cover" />
            <div>
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-700">Tshering Tobgay</p>
                <p className="text-gray-500">Haa - Sombaykha</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-12">Party Candidates</h2>
