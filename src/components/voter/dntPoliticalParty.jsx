...
import dnt_leader from "../Assets/dnt_leader.jpeg";
import dnt from "../Assets/dnt.png";
import dntCandidates from '../data/dntCandidates';

const DntPoliticalParty = () => {
  // Pagination state
  ...
  const currentCandidates = dntCandidates.slice(indexOfFirstCandidate, indexOfLastCandidate);
  const totalPages = Math.ceil(dntCandidates.length / candidatesPerPage);
...
export default DntPoliticalParty;